# experiments/test_trainer_reverse_dilatillation_mvtec.py
import os, sys
...
if __name__ == "__main__":
    ...
    from vad_mini.models.reverse_distillation.trainer import ReverseDistillatonTrainer

    trainer = ReverseDistillatonTrainer(backbone="wide_resnet50_2", anomaly_map_mode="add")
