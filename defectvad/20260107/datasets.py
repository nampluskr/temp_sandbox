...
if __name__ == "__main__":
    ...
    if 1:
        ...
        for category in dataset.category:
            print(f" > {category}: {dataset.count_category(category)} "
                  f"(normal {dataset.count_normal(category)}, "
                  f"anomaly {dataset.count_anomaly(category)})"
            )
    ...
    if 1:
        ...
        for category in dataset.category:
            print(f" > {category:10}: {dataset.count_category(category)} "
                  f"(normal {dataset.count_normal(category)}, "
                  f"anomaly {dataset.count_anomaly(category)})"
            )
