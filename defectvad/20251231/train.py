...
def main1(dataset_name, category_name, model_name):
    #################################################################
    # Configuration
    #################################################################
    ...
    config = merge_configs(
        ...
        load_config(os.path.join(model_dir, f"{model_name}.yaml")),
...
def main2(dataset_name, category_name, model_name):
    #################################################################
    # Configuration
    #################################################################

    model_dir = os.path.join(source_dir, "defectvad", "models", model_name)
    config = load_config(os.path.join(model_dir, f"{model_name}.yaml"))
...
if __name__ == "__main__":
    ...
    # main1(args.dataset, args.category, args.model)
    main2(args.dataset, args.category, args.model)
